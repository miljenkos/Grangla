...
public class SinglePlayerGamePlayActivity extends AppCompatActivity implements TableFragment.OnFieldSelectedListener {
    ...
    class UIPut implements Runnable {
        ...
        private void checkIfGameEnded(){
            if ((result<=0) ||
                ...
                endDialog = new EndDialog(SinglePlayerGamePlayActivity.this, R.style.EndDialog);
