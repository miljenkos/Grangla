...
public class MultiplayerGamePlayActivity extends AppCompatActivity implements TableFragment.OnFieldSelectedListener {
    ...
    class UIPut implements Runnable {
        ...
        public void run() {
            ...
            if ((result<=0) ||
                ...
                endDialog = new FullscreenDialog(MultiplayerGamePlayActivity.this, R.style.EndDialog);
